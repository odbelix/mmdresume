...
class TechtopType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            //->add('username')
            ->add('profession',EntityType::class, array('label' => 'Título de Técnico de Nivel Superior',
                  'class' => 'ResumeBundle:Profession',
                  'placeholder' => "Selecciona título de técnico de nivel superior",
